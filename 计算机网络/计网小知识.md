...
1. **缓存处理**
   ...
   **If-Modified-Since** 则是由客户端发送给服务器的HTTP请求头标签
   ...
   ![image-20210410111444743](https://i.loli.net/2021/08/30/gKMxtZuosRzwO3k.png)
...
![image-20210410162753867](https://i.loli.net/2021/08/30/NKHbgotBqVYulI9.png)

仔细观察上图：在tcp链接中，http请求必须等待前一个请求响应之后，才能发送，后面的依次类推，由此可以看出，如果在一个tcp通道中如果某个http请求的响应因为某个原因没有及时返回，后面的响应会被阻塞，这就是**队头阻塞**。

![image-20210410163153807](https://i.loli.net/2021/08/30/sZi7dPfMglko1mF.png)
...
![image-20210814234315281](https://i.loli.net/2021/08/30/LD75RMqc2wZpoVX.png)
...
![image-20210828113321419](https://i.loli.net/2021/08/30/LD75RMqc2wZpoVX.png)
...
![image-20210828113315085](https://i.loli.net/2021/08/30/Fdg4apkDtCmHb2G.png)

# 35. ICMP

原文链接: https://blog.csdn.net/m0_37268841/article/details/109165302

![image-20210828113829954](https://i.loli.net/2021/08/30/YDB7wQR49X3JyVC.png)
